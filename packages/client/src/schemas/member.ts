...
export const updateMemberProfileImageSchema = z.boolean();
export type UpdateMemberProfileImageResponse = BaseResponse<
  typeof updateMemberProfileImageSchema
>;
export type UpdateMemberProfileImage = z.infer<
  typeof updateMemberProfileImageSchema
>;
export type DeleteMemberProfileImageResponse = BaseResponse<
  typeof updateMemberProfileImageSchema
>;
export type DeleteMemberProfileImage = z.infer<
  typeof updateMemberProfileImageSchema
>;