    ...
    },
    {
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: PrivateAwardQueryKeys.AWARDS,
        });
      },
      onError: (error) => {
  ...
  return useMutation<unknown, unknown>(
    ...
    },
    {
      onSuccess: () => {
        ...
        queryClient.invalidateQueries({
          queryKey: PrivateAwardQueryKeys.AWARD_DETAIL(awardUUID),
        });
      },
      onError: (error) => {
...
export const useCreateAwardMember = (awardUUID: AwardUUID) => {
  ...
  return useMutation<unknown, CreateAwardMember>(
    ...
    },
    {
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: PrivateAwardQueryKeys.AWARD_MEMBERS(awardUUID),
        });
        queryClient.invalidateQueries({
          queryKey: PrivateAwardQueryKeys.AWARD_DETAIL(awardUUID),
        });
...
export const useCompetitionAwardList = (competitionUUID: CompetitionUUID) => {
  return useQuery<CompetitionAwardListResponseSchema>(
    PrivateAwardQueryKeys.COMPETITION_AWARDS(competitionUUID),
    {
      method: HttpMethod.GET,
...
export const useDeleteCompetition = (competitionUUID: CompetitionUUID) => {
  ...
  return useMutation<unknown, unknown>(
    ...
    },
    {
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: PrivateAwardQueryKeys.COMPETITIONS,
        });
        queryClient.invalidateQueries({
          queryKey: PrivateAwardQueryKeys.COMPETITION_AWARDS(competitionUUID),
        });
      },
      onError: (error) => {
