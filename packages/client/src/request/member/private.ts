...
import { CreateMember, MemberLinkWithoutID, MemberListResponse, MemberResponse, MemberSkill, MemberSkillWithoutUUID } from "@/schemas/member"
...
export const usePrivateUpdateMember = () => {
    return useDynamicMutation<MemberResponse, MemberUUIDParam, CreateMember>(
        HttpMethod.PATCH,
        ({ memberUUID }) => `/admin/members/${memberUUID}`,
    )
}
...
export const usePrivateCreateMemberLink = () => {
    return useDynamicMutation<MemberResponse, MemberUUIDParam, MemberLinkWithoutID>(
        HttpMethod.POST,
...
export const usePrivateUpdateMemberLink = () => {
    return useDynamicMutation<MemberResponse, MemberUUIDWithLinkParam, MemberLinkWithoutID>(
        HttpMethod.PATCH,
        ({ memberUUID, linkUUID }) =>
...
export const usePrivateCreateMemberSkill = () => {
    return useDynamicMutation<MemberSkill, MemberUUIDParam, MemberSkillWithoutUUID>(
        HttpMethod.POST,
        ({ memberUUID }) => `/admin/members/${memberUUID}/skills`,
    )
}
...
export const usePrivateUpdateMemberSkill = () => {
    return useDynamicMutation<MemberSkill, MemberUUIDWithSkillParam, MemberSkillWithoutUUID>(
        HttpMethod.PATCH,
