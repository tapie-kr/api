...
describe('Permissions', () => {
  describe('hasPermission', () => {
    it('should return true when user has the required permission', () => {
      ...
      expect(Permissions.hasPermission(userPermissions, Permissions.DESIGN_CLASS_ACCESS)).toBe(
        true,
      );
    });
  ...
  describe('grantPermission', () => {
    it('should add new permission to user permissions', () => {
      ...
      userPermissions = Permissions.grantPermission(
        userPermissions,
  ...
  describe('revokePermission', () => {
    it('should remove permission from user permissions', () => {
      ...
      userPermissions = Permissions.revokePermission(
        userPermissions,
        Permissions.DESIGN_CLASS_ACCESS,
      );
      expect(Permissions.hasPermission(userPermissions, Permissions.DESIGN_CLASS_ACCESS)).toBe(
  ...
  describe('predefined permission sets', () => {
    ...
    it('should correctly set DEVELOPER_CLASS_STUDENT permissions', () => {
      ...
      expect(Permissions.hasPermission(permissions, Permissions.DEVELOPER_CLASS_MANAGE)).toBe(
        false,
      );
    });
